        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-8">
          ...
          <div className="md:w-1/2">
            ...
            <p className="text-gray-700 mb-4">
              <strong>We are Qtech —</strong> an ICT company for those who don't
              have an ICT department. This website is where you can submit
              tickets so we can help solve your ICT-related concerns, questions,
              and issues.
            </p>
            <p className="italic text-gray-600">
              Qtech Business Solutions, Inc. (formerly Qtech BPO) is a software
              development company and electronic security hardware integrator
              based in the Philippines. Qtech’s services are offered globally on
              a project or strategic-staffing basis in both custom and
              off-the-shelf package environments across all technology
              platforms, operating systems, and infrastructures. We also offer
              system integration and consultancy with superior value-priced
        ...
        <div className="max-w-6xl mx-auto space-y-10">
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div>
              ...
              <p className="text-2xl text-gray-900 leading-relaxed">
                Become the prime IT Solutions Provider in the country and enable
                our business clientele achieve their objectives through
                automation.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            <div>
              ...
              <p className="text-2xl text-gray-900 leading-relaxed">
                Solve the most challenging technology problems to ensure the
                success of our business clienteles.
                <br />
      ...
      <div className="py-12 px-4 max-w-6xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-gray-50 p-6 rounded-xl shadow-md text-left">
            ...
            <p className="text-gray-700 text-sm">
              We at Qtech understand the needs and requirements of our customers
              and make technology resolve what they need and help them realize
          ...
          <div className="bg-gray-50 p-6 rounded-xl shadow-md text-left">
            ...
            <p className="text-gray-700 text-sm">
              Qtech knows how to use appropriate technology based on customer
          ...
          <div className="bg-gray-50 p-6 rounded-xl shadow-md text-left">
            ...
            <p className="text-gray-700 text-sm">
              Many companies have already embraced outsourcing. We ensure that
              our customers fully benefit from it in their businesses.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mt-6">
          ...
          <div className="bg-gray-50 p-6 rounded-xl shadow-md text-left">
            ...
            <p className="text-gray-700 text-sm">
              Qtech is a community of talented, bright professionals who are
              easy to work with. We pride ourselves on fostering a collaborative
          ...
          <div className="bg-gray-50 p-6 rounded-xl shadow-md text-left">
            ...
            <p className="text-gray-700 text-sm">
              Our international experience and affiliations allow Qtech to
              compete with the top IT solutions companies. This global
              perspective helps us deliver cutting-edge solutions to our
              clients.
            </p>
          </div>
        </div>
