    ...
    const mockData = [
      {
        ...
        issue: "Customer unable to complete transaction using QRIS on mobile POS. Error code 504 appears.",
        status: "Unresolved",
        customer: "John Doe",
      ...
      },
      {
        ...
        issue: "Accounting summary page not loading for fiscal year 2023. Blank screen after login.",
        status: "Resolved",
        customer: "Jane Smith",
      ...
      },
      {
        id: "TICK-1003",
        category: "POS for Retail and F&B",
        issue: "Discount calculation on combined orders is incorrect, not reflecting in customer receipt.",
        status: "Pending",
        customer: "David Lee",
      ...
      },
      {
        id: "TICK-1004",
        category: "qSA (Quick Accounting)",
        issue: "Cannot export sales reports to PDF, export button is greyed out despite proper permissions.",
        status: "Unresolved",
      ...
      },
      {
        id: "TICK-1005",
        category: "POS for Retail and F&B",
        issue: "Inventory syncing delays between central server and branch POS terminals.",
        status: "Resolved",
