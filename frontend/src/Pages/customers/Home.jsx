...
const Home = () => {
  ...
  return (
    ...
    >
      <div
        className="bg-blue-900 text-white px-15 lg:px-35 py-20 lg:py-40 mb-8 flex flex-col lg:flex-row items-center justify-between shadow-md bg-contain bg-center"
        style={{
        ...
        <div className="grid lg:grid-cols-3 p-12 lg:p-2 gap-6">
          ...
          <div className="bg-white px-15 py-10 rounded-lg shadow-md text-left transform transition-all duration-200 hover:scale-103">
            ...
            <p className="text-gray-700 text-sm lg:text-md text-center max-w-md mx-auto lg:text-justify">
              ...
              you with any issues or questions, ensuring your ticketing system
              runs smoothly.
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center gap-10">
          <div className="flex flex-col space-y-2 mx-auto mt-2">
            ...
            <div className="flex flex-col">
              <div className="relative text-center lg:text-left flex justify-center lg:justify-start">
                <Link to="/customer/create-ticket">
                  <button
                    className="mt-8 bg-blue-500 text-white hover:bg-blue-700 text-md lg:text-lg py-2 md:py-3 px-3 md:px-5 rounded-md flex 
        items-center justify-center w-full md:w-auto cursor-pointer group transition"
                  >
                    Submit Ticket
                    <FaArrowRight className="ml-4 transform -rotate-45 transition duration-300 group-hover:rotate-0" />
                  </button>
                </Link>
              </div>
            </div>
        ...
        <div className="grid lg:grid-cols-3 p-12 lg:p-2 gap-6">
          <div className="bg-gray-50 px-12 py-10 rounded-lg shadow-md text-left ">
            <p className="text-gray-600 text-xl lg:text-xl text-justify max-w-md mx-auto lg:text-justify">
              “We have tried other HRIS providers before, but Qtech’s systems is
              the only one that fits our construction company well. It addresses
              our unique requirements having multiple types of payments and with
              multiple locavtions. Now, we are excited to implement their full
              ERP solution."
            </p>
          ...
          <div className="bg-gray-50 px-12 py-10 rounded-lg shadow-md text-left ">
            <p className="text-gray-600 text-xl lg:text-xl text-justify max-w-md mx-auto lg:text-justify">
              “Fast and Friendly Assistance All you guys are awesome! Thanks for
              always helping me. Always very nice and friendly. It was great and
              handled very fast. They worked around my conference call and fixed
