...
const CustomerTicket = () => {
  ...
  return (
    <div className={`mx-5 md:mx-5 lg:mx-5 transition-all duration-300`}>
      <div className="bg-white shadow-[0_4px_4px_rgba(0,0,0,0.25)] rounded-lg mt-10 md:mt-2 mb-10 max-w-7xl mx-auto">
        {/* Welcome Banner */}
        <div className="bg-[#08032B] text-white rounded-t-lg px-6 lg:px-18 py-10 lg:py-4 mb-8 flex flex-col lg:flex-row items-center justify-between shadow-md">
          {/* Left Side - Text */}
          ...
          {/* Right Side - Image */}
          <div className="hidden lg:flex mt-6 md:mt-0 md:w-1/3 justify-center">
            <img
              src={image}
        ...
        <div className=" rounded-xl p-6 mb-10 max-w-6xl mx-auto ">
          <div className="mb-5">
            ...
            <h1 className="text-2xl mb-2 font-bold text-blue-600 text-center">
              Ask us anything
            </h1>
