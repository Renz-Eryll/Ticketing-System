...
export const AgentTickets = () => {
  ...
  return (
    <div className=" max-w-7xl  mx-auto px-4 sm:px-10 lg:px-8 mt-35 lg:mt-35">
      <div className="text-3xl font-bold text-[#1D4ED8] ">My Tickets</div>
      <div className="max-w mt-8 p-10 border border-gray-100 shadow-sm rounded-xl bg-white min-h-[440px]">
