          ...
          <div className="mt-5 px-5 xl:px-30">
            <div className="flex flex-col md:flex-row gap-10 w-full justify-between">
              <div className="w-full md:w-1/2 max-w-sm flex flex-col gap-5">
                <div
                  className="bg-[#08032B] rounded-lg text-white p-6 shadow w-full hover:bg-[#08032B]/90 cursor-pointer transition-all duration-300 flex flex-col items-center gap-4"
                  onClick={() => handleCategoryClick("Inventory Support")}
                >
                  <img
                    src={categoryImage}
                    alt="image"
                ...
                <div
                  className="bg-[#08032B] rounded-lg text-white p-6 shadow w-full hover:bg-[#08032B]/90 cursor-pointer transition-all duration-300 flex flex-col items-center gap-4"
                  onClick={() => handleCategoryClick("Utility Billing")}
                >
                  <img
                    src={categoryImage}
                    alt="image"
                ...
                <div
                  className="bg-[#08032B] rounded-lg mb-5 text-white p-6 shadow w-full hover:bg-[#08032B]/90 cursor-pointer transition-all duration-300 flex flex-col items-center gap-4"
                  onClick={() => handleCategoryClick("HR Payroll System")}
                >
                  <img
                    src={categoryImage}
                    alt="image"
              ...
              <div className="-full md:w-1/2 max-w-sm flex flex-col gap-5">
                <div
                  className="bg-[#08032B] rounded-lg text-white p-6 shadow w-full hover:bg-[#08032B]/90 cursor-pointer transition-all duration-300 flex flex-col items-center gap-4"
                  onClick={() => handleCategoryClick("POS Retail")}
                >
                  <img
                    src={categoryImage}
                    alt="image"
                ...
                <div
                  className="bg-[#08032B] rounded-lg text-white p-6 shadow w-full hover:bg-[#08032B]/90 cursor-pointer transition-all duration-300 flex flex-col items-center gap-4"
                  onClick={() => handleCategoryClick("Accounting System")}
                >
                  <img
                    src={categoryImage}
                    alt="image"
