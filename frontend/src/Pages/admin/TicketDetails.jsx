...
export const TicketDetails = () => {
  ...
  if (!ticketData) {
    return <div className="text-center text-red-500 mt-10">Error: Ticket data not available.</div>;
  }

  return (
    <div className={`mx-5 md:mx-5 lg:mx-5 transition-all duration-300 ${activeMenu ? "lg:pl-75" : "lg:pl-25"}`}>
      <div className="flex gap-4">
        <IoMdArrowBack className="text-4xl cursor-pointer" onClick={() => navigate("/admin/tickets")} />
