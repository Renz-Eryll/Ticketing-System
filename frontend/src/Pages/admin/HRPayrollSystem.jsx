 ...
 const [loading, setLoading] = useState(true);
  ...
  async function fetchData() {
    try {
      ...
      // Fetch tickets
      const ticketsRes = await fetch(`http://localhost:8000/api/payroll`, {
  ...
  return (
    <div className={`mx-5 transition-all duration-300 ${activeMenu ? "lg:pl-75" : "lg:pl-25"}`}>
      <div className="flex gap-4 items-center">
        ...
        />
        <div className="text-3xl font-bold text-[#1D4ED8]">Philippine HR, Payroll and Time Keeping System</div>
      </div>
